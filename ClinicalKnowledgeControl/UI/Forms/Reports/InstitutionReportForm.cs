...
{
    public partial class InstitutionReportForm : Form
    {
        private readonly ReportService _service;

        public InstitutionReportForm()
        {
            InitializeComponent();
        ...
        {
            this.Text = "Отчет по учреждению";
            this.Size = new System.Drawing.Size(1100, 700);

            var tabControl = new TabControl { Name = "tabControl", Dock = DockStyle.Fill };

            var tabSummary = new TabPage("Сводка по учреждению");
        ...
        {
            var summary = _service.GetInstitutionReport();
            ...
            dgvSummary.Columns[2].HeaderText = "Отделение";
            dgvSummary.Columns[2].DefaultCellStyle.WrapMode = DataGridViewTriState.True;
            dgvSummary.Columns[3].HeaderText = "Наименование теста";
            dgvSummary.Columns[3].DefaultCellStyle.WrapMode = DataGridViewTriState.True;
            dgvSummary.Columns[4].HeaderText = "Дедлайн";
            dgvSummary.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dgvSummary.Columns[5].HeaderText = "Статус";
            dgvSummary.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dgvSummary.Columns[6].HeaderText = "Баллов";
            dgvSummary.Columns[6].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dgvSummary.Columns[7].HeaderText = "Дата окончания";
            dgvSummary.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
